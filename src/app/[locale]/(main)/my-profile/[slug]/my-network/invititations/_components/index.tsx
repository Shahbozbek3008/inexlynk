...
import { useInvitationQuery } from "../../_hooks/use-invitation-query"

export const InvitationsPage = () => {
    const t = useTranslations()
    const params = useSearch()
    const { data, invitations, isPending } = useInvitationQuery({
        params,
    })
    ...
    return (
        <>
            <div className="flex flex-col rounded-md bg-white shadow-[var(--card-shadow)]">
                ...
                {isPending ?
                    <SkeletonTable />
                :   <CustomTable activeTab="invitations" data={invitations} />}
