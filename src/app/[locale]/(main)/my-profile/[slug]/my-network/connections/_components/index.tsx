...
import { useConnectionsQuery } from "../../_hooks/use-connection-query"

export const ConnectionsPage = () => {
    const t = useTranslations()
    const params = useSearch()
    const { data, connections, isPending } = useConnectionsQuery({
        params: {
            ...params,
        },
    })
    ...
    return (
        <>
            <div className="flex flex-col rounded-md bg-white shadow-[var(--card-shadow)]">
                ...
                {isPending ?
                    <SkeletonTable />
                :   <CustomTable activeTab="connections" data={connections} />}
