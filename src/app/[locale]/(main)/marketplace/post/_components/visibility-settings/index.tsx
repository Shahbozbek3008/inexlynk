...
const VisibilitySettings = () => {
    ...
    return (
        <div className="clamp-[mt,4,10] grid grid-cols-1 sm:grid-cols-2 sm:gap-10 items-center">
            <SelectField
                methods={methods}
                ...
                onValueChange={(opt) => {
                    if (opt?.id === "manual") {
                        ...
                        methods.setValue("visibility_permission_users_ids", [])
                    }
                }}
            ...
            <Modal
                className="sm:max-w-7xl px-2 sm:px-6"
