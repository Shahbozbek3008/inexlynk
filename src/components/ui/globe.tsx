...
export function Globe({ globeConfig, data }: WorldProps) {
    ...
    useEffect(() => {
        if (!globeRef.current && groupRef.current) {
            globeRef.current = new ThreeGlobe() as unknown as ThreeGlobe &
                import("three").Object3D<import("three").Object3DEventMap>
            groupRef.current.add(
                globeRef.current as import("three").Object3D<
