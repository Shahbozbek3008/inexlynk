        ...
        >
            ...
            <div className="relative flex items-center">
                <NumericFormat
                    id={name}
                    className={cn(
                        "flex clamp-[h,10,12] w-full rounded-md border border-input bg-background px-3 py-1 clamp-[text,sm,base] shadow-sm transition-colors file:border-0 file:bg-transparent file:clamp-[text,sm,base] file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
                        rightIcon && "pr-12",
                        className,
                    )}
                    thousandSeparator={" "}
